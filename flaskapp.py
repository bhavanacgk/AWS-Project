...
def responsePage(firstname, lastname, email, count):
    return """<b> First Name : </b>""" + str(firstname) + """ <br><b> Last Name : </b>""" + str(lastname) + """ <br><b> E-mail id : </b>""" + str(email) + """ <br><b>The Word Count of the File that you've uploaded is : </b> """ + str(count) + """ <br><br><b><a href="/download" >Download your file here!</a></b> """
